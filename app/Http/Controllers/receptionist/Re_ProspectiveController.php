...
use Auth;
use Str;
class Re_ProspectiveController extends Controller
{
    public function list(){
        $data['getRecord']=User::getProspective();
    return view('receptionist.prospective.list',$data);   
    }
   
    public function add(){

        $data['getClass']=ClassModel::getClass();
    return view('receptionist.prospective.add',$data);  
    }
...
public function edit($id)
    { 
        ...
        if(!empty($data['getRecord']))
        {
            ...
            $data['getClass']=ClassModel::getClass();
            return view('receptionist.prospective.edit',$data);
        }
        else{
            abort(404);
        }
