...
<tr>
  ...
  <a href="{{ route('branchadmin.exam_timetable.edit', ['id' => $value->id, 'class_id' => $value->class_id]) }}" class=" w3-button w3-blue">Edit</a>
      <a href="{{url('branchadmin/exam_timetable/delete/'.$value->id)}}" class=" w3-button w3-red">Delete </a>
  </td>
</tr>
@endforeach
  </tbody>
