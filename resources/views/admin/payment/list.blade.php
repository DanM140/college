...
<div class="w3-container">
  ...
  <br/>
  <a href="{{url('/admin/payment/pay_aggregate')}}" class="w3-left w3-button w3-blue">Payment List </a>
  </div>
...
<tr>
      ...
      <a href="{{ route('admin.payment.payment', ['id' => $value->id, 'term' => $value->term]) }}" class="w3-blue">Cash</a>
      <a href="{{ route('admin.payment.bank', ['id' => $value->id, 'term' => $value->term]) }}" class="w3-blue">Bank</a>
      <a href="{{ route('admin.payment.mpesa', ['id' => $value->id, 'term' => $value->term]) }}" class="w3-blue">Mpesa</a>
