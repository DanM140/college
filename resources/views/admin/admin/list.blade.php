...
<div class="w3-container">
  <a href="{{url('admin/admin/add')}}" class="w3-right w3-button w3-blue">Add new  Admin </a>
  </div>
...
<tr>
      ...
      <td><a href="{{url('admin/admin/edit/'.$value->id)}}" class=" w3-button w3-blue">Edit </a>
      <a href="{{url('admin/admin/delete/'.$value->id)}}" class=" w3-button w3-red">Delete </a>
    </td>
    </tr>
@endforeach
  </tbody>
